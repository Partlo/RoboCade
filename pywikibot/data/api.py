    ...
    def login_to_site(self) -> None:
        ...
        if hasattr(self, '_waituntil'):
            if datetime.datetime.now() < self._waituntil:
                ...
                pywikibot.warning('Too many tries, waiting {} seconds before retrying.'.format(diff.seconds))
            ...
            if self.site.mw_version >= '1.29.0-wmf.14':
                try:
                    ...
                    pywikibot.log(
                        ...
                        'Please file the following debug message to Phabricator task T261061:\n{}'
                        .format(login_result))
                    raise CaptchaError('Captcha encountered which cannot be handled:\n{}'.format(response))
